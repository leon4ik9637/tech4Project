...
public class WorkCode {
    public static void main(String[] args){
        ...
        // 2nd way short cut using if - else if - else if -else statement
        ...
        */
        // 3rd way - switch cases

        switch (day){ // 1
            case 1:
                System.out.println("Blue");
                break; // break is for java to stop looking for whatever it is looking for
            // after it finds what it's looking for and goes out of figure brackets
            case 2:
