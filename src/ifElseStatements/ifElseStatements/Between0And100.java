...
public class Between0And100 {
    public static void main(String[] args) {
        /*
        Write a program asks user to put number and checks if the number is between
        0 and 100
        If it is true print out " It is in between 0 and 10"
        else "it is not in between 0 and 100"
         */

        Scanner scan = new Scanner(System.in);

        System.out.println("Write a number below:");
